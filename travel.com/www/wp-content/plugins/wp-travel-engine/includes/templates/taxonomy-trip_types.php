                                ...
                                while($wte_trip_tax_post_qry->have_posts()) :
                                    ...
                                    <div class="col">
                                        <div class="img-holder">
                                            ...
                                            { ?>
                                                <img itemprop="image" src="<?php echo esc_url( $feat_image_url[0] );?>">
                                            <?php
                                            }
                                            else{
                                               echo '<img itemprop="image" src="'.esc_url(  WP_TRAVEL_ENGINE_IMG_URL . '/public/css/images/trip-listing-fallback.jpg' ).'">';
                                            }?>
                                            </a>
                                              <?php
                                                $code = 'USD';
                                        ...
                                        <div class="text-holder">
                                            <h3 class="title" itemprop="name"><a href="<?php echo esc_url( get_the_permalink() );?>"><?php the_title();?></a></h3>
                                            <?php
                                        ...
                                        <div class="col">
                                            <div class="img-holder">
                                                ...
                                                <?php
                                                    ...
                                                    <img itemprop="image" src="<?php echo esc_url(  WP_TRAVEL_ENGINE_IMG_URL . '/public/css/images/trip-listing-fallback.jpg' );?>">
                                                <?php } ?>
                                                </a>
                                                  <?php
                                                    $code = 'USD';
