    ...
    */
    function bttk_social_template() { ?>
        <div class="bttk-contact-social-template">
            <li class="bttk-contact-social-icon-wrap" data-id={{ind}}>
                ...
                <span class="bttk-contact-social-links-field-handle dashicons dashicons-plus"></span>
                ...
                <span class="del-contact-bttk-icon dashicons-no" style="font-family: 'dashicons'"></span>
            </li>
        </div>
    <?php
    echo '<style>
    ...
    public function widget( $args, $instance ) {
        ...
        <?php 
            ...
            if( isset( $instance['social_profile'] ) && !empty($instance['social_profile']) ){ 
                $icons = $instance['social_profile']; ?>                
                <ul class="social-networks">
                    <?php
                        $arr_keys  = array_keys( $icons );
                        foreach ($arr_keys as $key => $value)
                        { 
                            if ( array_key_exists( $value,$instance['social_profile'] ) )
                            { 
                                $icon = $this->bttk_get_social_icon_name( $instance['social_profile'][$value] );
                                if( in_array( $this->bttk_get_social_icon_name( $instance['social_profile'][$value] ), $allowed_socicon ) )
                                {
                                ?>
                                <li class="bttk-contact-social-icon-wrap">
                                    <a <?php if(isset($instance['target']) && $instance['target']=='1'){ echo "target=_blank"; } ?> href="<?php echo esc_url($instance['social'][$value]);?>"><span class="bttk-contact-social-links-field-handle fa fa-<?php echo esc_attr($icon);?>" style="font-family: 'FontAwesome';"></span></a>
                                </li>
                            <?php
                                }
                            }
    ...
    public function form( $instance ) {
        ...
        <?php
        if(isset($instance['social_profile']))
        {
            $icons  = $instance['social_profile'];
            $arr_keys  = array_keys( $icons );
            $allowed_socicon = $this->bttk_allowed_socicons();
                    ...
                    { 
                        ...
                        ?>
                            <li class="bttk-contact-social-icon-wrap" data-id="<?php echo $value;?>">
                                    <span class="btab-contact-social-links-sortable-handle"></span>
                                    <span class="bttk-contact-social-links-field-handle fa fa-<?php echo esc_attr( $icon )?>" style="font-family: 'FontAwesome'"></span>
                                    ...
                                    <span class="example-text">Example: facebook</span>
                                    <div class="social-search-wrap"><input class="user-social-profile" id="<?php echo esc_attr( $this->get_field_id( 'social_profile['.$value.']' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'social_profile['.$value.']' ) ); ?>" type="text" value="<?php echo esc_attr($this->bttk_get_social_icon_name($instance['social_profile'][$value]));?>" /></div>
