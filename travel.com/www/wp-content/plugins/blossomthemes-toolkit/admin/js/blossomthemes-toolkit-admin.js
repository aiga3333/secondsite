jQuery(document).ready(function($){
    ...
    $(document).on('click','.bttk-icons-list li',function(event) {
        ...
        $(this).parent().siblings('.user-contact-social-profile').attr('value', val);
        $(this).parent().siblings('.bttk-contact-social-length').attr('value','https://'+val+'.com');
    ...
    $(document).on('click','.bttk-icons-list li',function(event) {
        ...
        $(this).parent().parent().siblings('.bttk-contact-social-length').attr('value','https://'+val+'.com');
        $(this).parent().parent().siblings('.bttk-social-length').attr('value','https://'+val+'.com');
        $(this).parent().siblings('.user-social-links').attr('value','https://'+val+'.com');
        $(this).parent().siblings('.user-social-links').trigger('change');
    ...
    $('body').on('click', '.del-bttk-icon', function() {
        ...
        if ($('.del-bttk-icon').length < 1) {
            $('.bttk-social-add').removeAttr('disabled');
        }
    });
    $('body').on('click', '.del-contact-bttk-icon', function() {
        ...
        if ($('.del-contact-bttk-icon').length < 1) {
            $('.bttk-contact-social-add').removeAttr('disabled');
        }
    });
    ...
    $(document).on('click','.bttk-icons-list li',function(event) {
        var val = $(this).children().attr('class');
        val = val.substring(val.indexOf('-')+1);
        $(this).parent().siblings('.bttk-social-length').attr('value','https://'+val+'.com');
        $(this).parent().siblings('.bttk-social-icons-field-handle').removeClass('dashicons dashicons-plus').attr('class','fa fa-'+val);
    ...
    $('body').on('click', '.bttk-itw-add', function(e) {
        ...
        $('.itw-holder').before(newinput.html());
        // $(this).siblings('.bttk-sortable-links').find('.bttk-social-icon-holder').before(newinput.html());
    });
    ...
    $(document).on('click', '.bttk-font-group li', function() {
        ...
        var aa = $(this).parents('.bttk-font-awesome-list').find('.bttk-font-group li.selected').children('i').attr('class');
    ...
    $(document).on('widget-updated', function(e, widget) {
        ...
        if ($this.find('i').hasClass('fa')) {
            $this.children('i').after('<a class="bttk-remove-icon"></a>');
        }
    });
